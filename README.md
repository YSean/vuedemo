...
## 术语
spa模式:单页Web应用（single page web application，SPA），就是只有一张Web页面的应用，是加载单个HTML 页面并在用户与应用程序交互时动态更新该页面的Web应用程序.
...
- ajax库：[https://cdn.jsdelivr.net/npm/axios@0.12.0/dist/axios.min.js]
- lodash库：[https://cdn.jsdelivr.net/npm/lodash@4.13.1/lodash.min.js]
- velocity 库：[https://cdnjs.cloudflare.com/ajax/libs/velocity/1.2.3/velocity.min.js]
